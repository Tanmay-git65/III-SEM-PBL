...
\fcolorbox{black}{lightbox}{
  \parbox{0.9\linewidth}{\centering \bfseries\itshape Personal Finance / Expense Splitter}
}
\end{center}
...
\includegraphics[width=2.2cm]{tanmay.jpg} \\
\hline
Team Member 2 &
\textbf{Hemang Sethi} \newline
2510370341 \newline
2510370341@geu.ac.in &
\includegraphics[width=2.2cm]{hemang.jpg} \\
\hline
Team Member 3 &
\textbf{Sparsh Saxena} \newline
2510370313 \newline
2510370313@geu.ac.in &
\includegraphics[width=2.2cm]{sparsh.jpg} \\
\hline
\end{tabularx}
\end{center}
...
Managing shared expenses among friends, roommates, classmates, or travel groups is a common problem in everyday life. When multiple people contribute different amounts toward food, transportation, accommodation, shopping, or other group activities, it becomes difficult to accurately track who paid, how much each person owes, and whom they need to pay. Usually, people depend on manual calculations, notes, spreadsheets, or chat messages to keep track of these expenses. This often leads to confusion, calculation errors, forgotten payments, and unnecessary disagreements within the group.

Another major issue is the difficulty of settling balances efficiently. For example, if one person has paid Rs.\,1{,}000, another Rs.\,500, and others have paid smaller amounts, determining the minimum number of transactions required to settle everyone's balance can be time-consuming when done manually. Handling expenses in different currencies can make the calculation even more complicated, especially when members are travelling together.

The proposed Personal Finance/Expense Splitter aims to solve these problems by providing a simple system for recording users, groups, and transactions and automatically calculating individual balances. The system will determine how much each member owes or is owed and assist in simplifying the final settlement between group members.

The project will be implemented using Object-Oriented Programming concepts in C++, with separate classes for \texttt{User}, \texttt{Group}, and \texttt{Transaction}. Operator overloading will be used to make balance calculations and settlements more intuitive, while templates will provide flexible handling of different currencies and numerical values. The application is designed to be simple, relatable, and easy to demonstrate through real-life expense-sharing scenarios.

\subsection*{Project Goals and Milestones}

The primary goal of the Personal Finance/Expense Splitter project is to develop a simple, user-friendly application that helps individuals and groups efficiently manage and settle shared expenses. The system aims to reduce manual calculations, minimize errors, and provide a clear understanding of each member's financial contribution and outstanding balance.

\medskip
\noindent\textbf{The major goals of the project are to:}
\begin{itemize}[leftmargin=1.5em]
  \item Develop an Object-Oriented C++ application using classes such as \texttt{User}, \texttt{Group}, and \texttt{Transaction}.
  \item Allow users to create groups and record expenses shared among multiple members.
  \item Automatically calculate each member's share, amount paid, amount owed, and net balance.
  \item Implement operator overloading to simplify and demonstrate balance calculation and settlement operations.
  \item Use templates for flexible handling of different currencies and numerical data types.
...
The Personal Finance/Expense Splitter will be implemented using the concept of C++ to demonstrate the difference between procedural and object-oriented approaches. The application will allow users to create groups, record shared expenses, calculate individual shares, maintain balances, and settle payments efficiently.
